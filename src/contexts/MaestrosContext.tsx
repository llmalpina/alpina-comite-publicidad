...
const DEFAULT_CONFIG: MaestrosConfig = {
  ...
  tiposContenido: [
    { id: 't1', label: 'Imagen Estática', value: 'IMAGEN_ESTATICA', activo: true },
    { id: 't2', label: 'Video', value: 'VIDEO', activo: true },
    { id: 't3', label: 'Post Redes Sociales', value: 'POST_REDES', activo: true },
    { id: 't4', label: 'Material POP', value: 'MATERIAL_POP', activo: true },
    { id: 't5', label: 'Prensa', value: 'PRENSA', activo: true },
    { id: 't6', label: 'Televisión', value: 'TV', activo: true },
    { id: 't7', label: 'Otro', value: 'OTRO', activo: true },
  ],
