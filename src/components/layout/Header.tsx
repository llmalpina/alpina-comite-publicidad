  ...
  return (
    <header className="h-14 shrink-0 bg-brand-800 dark:bg-slate-950 border-b border-brand-700 dark:border-slate-800 flex items-center justify-between px-4 md:px-6 z-40 shadow-sm">
      ...
      <div className="flex items-center gap-2">
        ...
        <button onClick={() => { logout(); window.location.href = '/apprueba/login'; }} className="flex items-center gap-1.5 text-xs text-brand-100 hover:text-red-300 border border-brand-600 dark:border-slate-700 hover:border-red-400 px-3 py-1.5 rounded-lg transition-colors" title="Cerrar sesión">
